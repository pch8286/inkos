...
## 03_세력과_인물
주요 세력과 핵심 조연 (각 인물마다 이름, 정체성, 동기, 주인공과의 관계, 독자 목표)
...
### 초반 3화 설계 원칙
- 1화: 핵심 갈등을 즉시 던지고, 긴 배경 설명은 미루세요
- 2화: 1화의 압박에 맞서는 주인공의 핵심 강점/능력/레버리지를 보여주세요
- 3화: 독자가 계속 읽을 이유가 되는 첫 번째 구체적 단기 목표를 세우세요`
...
4. 떡밥과 회수가 앞뒤로 맞물릴 것
5. 조연도 도구가 아니라 독자 동기와 계산을 가진 인물로 설계할 것`
      : `生成内容必须：
